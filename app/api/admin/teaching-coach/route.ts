...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await runSolver({ model: settings.primary.model, reasoning: settings.primary.reasoning, prompt, expectJson: true });
