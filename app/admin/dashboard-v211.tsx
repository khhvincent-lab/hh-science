...
export default function DashboardV211({
  ...
  return <div className={styles.dashboard}>
    <div className={styles.intro}><div><div className={styles.eyebrow}>OPERATIONS OVERVIEW / V2.1.4</div><h2>今天的解題實驗室</h2><p>掌握解題使用、班級動態與 AI 成本。所有數字依目前登入權限顯示。</p></div><span className={styles.live}>台灣時間 · 即時資料</span></div>
