...
const workspaces:{key:string;title:string;intro:string;items:Destination[]}[]=[
  ...
  {key:"teaching",title:"教學引擎",intro:"從一題的校正，累積可重用的教學方法。",items:[{id:"teachingOverview",title:"教學總覽",detail:"知識累積與下一步"},{id:"teachingQuestions",title:"教師校正",detail:"檢視題目與改善解法"},{id:"teachingExamples",title:"範例庫",detail:"教師核准的解題案例"},{id:"teachingRuleLibrary",title:"規則庫",detail:"跨題重用的教學原則"},{id:"teachingCoach",title:"AI 教練",detail:"對話整理教學偏好"},{id:"teachingTraining",title:"訓練資料",detail:"整理與匯出教師知識"},{id:"teachingSettings",title:"全站預設",detail:"統一解題呈現方式"}]},
];
